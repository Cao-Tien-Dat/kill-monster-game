...
#define ICON_TOTAL_X  0  // tọa độ x cho icon total
#define ICON_TOTAL_Y  0  // tọa độ y cho icon total
...
//menu items axis y, total
uint8_t menu_items_icon_total_y [1]{
	0,
};
...
typedef struct {
	uint8_t axis_x = 40;//0
	uint8_t axis_y = 0;//0
	uint8_t size_w = 123;//123
	uint8_t size_h = 20;//20
	uint8_t size_r = 3;//3
} scr_menu_frames_t;
...
#define AR_GAME_MENU_ICON_AXIS_X			(50)
#define AR_GAME_MENU_TEXT_AXIS_X			(50)
#define AR_GAME_MENU_ICON_TOTAL_X 			(0)
	// Scroll bar
	...
	//icon total
		view_render.drawBitmap(ICON_TOTAL_X,      // Vị trí x
                       ICON_TOTAL_Y,      // Vị trí y
                       icon_total,        // Bitmap của icon total
                       30,                // Chiều rộng của icon total (ví dụ 30px)
                       64,                // Chiều cao của icon total (ví dụ 64px)
                       1);                
